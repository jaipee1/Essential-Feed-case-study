...
class CodableFeedStoreTests: XCTestCase {
    ...
    override func setUp() {
        ...
        let storeURL = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first!.appendingPathComponent(
            "image-feed.store"
        )
    ...
    func test_retrieveAfterInsertingToEmptyCache_deliversInsertedValues() {
        ...
        sut.insert(feed, timestamp: timestamp) { insertionError in
            ...
            sut.retrieve { retrieveResult in
                ...
                case .found(feed: let retrieveFeed, timestamp: let retrieveTimestamp):
